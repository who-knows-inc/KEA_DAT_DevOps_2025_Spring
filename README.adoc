...
link:00._Course_Material/02._Slides/11._Searching_Logging_Monitoring_Serverless/06._web_crawling_architectural_decisions.md[Web Crawling - Architectural Decisions]
