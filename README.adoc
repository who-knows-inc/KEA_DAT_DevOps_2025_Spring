...
link:00._Course_Material/02._Slides/11._Searching_Logging_Monitoring_Serverless/02._searching.md[Searching]
// Searching

link:00._Course_Material/02._Slides/11._Searching_Logging_Monitoring_Serverless/03._logging.md[Logging]
// Logging

link:00._Course_Material/02._Slides/11._Searching_Logging_Monitoring_Serverless/04._monitoring.md[Monitoring]
// Monitoring

link:00._Course_Material/02._Slides/11._Searching_Logging_Monitoring_Serverless/05._serverless_functions.md[Serverless]
// Serverless

link:00._Course_Material/02._Slides/11._Searching_Logging_Monitoring_Serverless/06._web_crawling_architectural_decisions.md[06._web_crawling_architectural_decisions]
