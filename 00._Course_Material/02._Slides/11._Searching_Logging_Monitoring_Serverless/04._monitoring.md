...
# Monitoring should be for everything
...
Prometheus will run on the server and expose the data in `/metrics`. Grafana can then query that endpoint from another server.
