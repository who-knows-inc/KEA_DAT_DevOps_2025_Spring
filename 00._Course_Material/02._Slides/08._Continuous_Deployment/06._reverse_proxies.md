...
* Directives has keys and values and are separated by semicolons.
...
*Does it work? It should! I can guarantee that we've done everything right. What is the issue? How can we fix it?* 

<details> 
  <summary>Solution</summary>
   The problem is that the browser has cached the CSS file. We need to clear the cache. Hard refresh the browser.
</details>
